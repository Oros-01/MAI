...
## О проекте
Проект в рамках учебной деятельности на **кафедре 307**, Институт №3, **МАИ**.

Захват является **универсальным**: благодаря датчику силы тока INA219 и обратной связи в реальном времени, устройство адаптирует усилие зажима — позволяя удерживать как хрупкие объекты, так и твёрдые предметы.
...
1. INA непрерывно считывает величину тока идущего к MG996R
